...
class _EditBudgetScreenState extends State<EditBudgetScreen> {
  ...
  void _initializeFields() {
    ...
    _allocatedAmountController.text = widget.budget.allocatedAmount.toString();
    _spentAmountController.text = widget.budget.spentAmount.toString();
  }
  ...
  Future<void> _loadExistingCategories() async {
    try {
      ...
      if (weddingEvent != null) {
        ...
        setState(() {
          _existingCategories = budgets
              .where((budget) => budget.id != widget.budget.id) // Exclude current budget
  ...
  Future<void> _updateBudget() async {
    if (_formKey.currentState!.validate()) {
      // Check if category already exists (excluding current budget)
      ...
      try {
        ...
        Fluttertoast.showToast(
          msg: "Budget entry updated successfully!",
